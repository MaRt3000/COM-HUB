...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className='flex justify-between items-center text-center px-8 bg-black/50 '>
      <img src={HeadLogo} alt="Page logo" className=' w-[80px] pt-4  z-[90]  ' />
            ...
            <Link to="/LandingPage" className="font-Jost flex flex-col items-center justify-center text-white text-[21px] hover:underline">
                Home
